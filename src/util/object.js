...
export class Entity {
  ...
  newField (field, value, date = false) {
    if (typeof (value) === 'undefined' || value == null || value === 'null' || value === '') return false
    if (typeof (this[field]) === 'undefined' || this[field] == null || this[field] === 'null' || this[field] === '') {
  ...
  changeFieldNumber (field, value) {
    if (typeof (value) === 'undefined' || value == null || value === 'null' || value === '') return false
    if (isNaN(value)) value = 0
    return this.changeField(field, value)
  }
...
export function changeFieldNumber (field, value) {
  if (typeof (value) === 'undefined' || value == null || value === 'null' || value === '') return false
  if (isNaN(value)) value = 0
